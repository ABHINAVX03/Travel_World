      ...
      <Container>
        <Row>
          ...
          >
            ...
            <div className="logo">
              <Link to="/home">
                {color=='light'?<img src={logo1} alt="" style={{marginTop:'-10px'}}/>:<img src={logo2} alt="" style={{marginTop:'-10px'}}/>}
              </Link>
            </div>
            {/* ========================== */}
            {/* ========== MENU START ========== */}
            <div className="navigation" ref={menuRef} id={color} onClick={toggleMenu}>
              <ul className="menu d-flex align-items-center gap-5" style={{backgroundColor:`${background}`}}>
                {nav__links.map((item, index) => (
                  color=='light'?<li className="nav__item2" key={index} id={color}>
                    <NavLink
                  ...
                  </li>:<li className="nav__item1" key={index} id={color}>
                    <NavLink
                      style={{textDecoration:'none'}}
                      to={item.path}
                      className={(navClass) =>
            ...
            <div className="nav__right d-flex align-items-center gap-3">
              <div className="nav__btns d-flex align-items-center gap-2">
                {user ? (
                  <>
                    {" "}
                    <Link to="/profile" style={{textDecoration:'none'}}><h5 className="mb-0 mx-4" id={color}>
                      <span style={{color:'#faa935',fontSize:'15px'}}>Hello!</span> {user.username}
                    </h5></Link>
                  ...
                  <>
                    <button className="change" id={color}>
                      <Link to="/login" style={{textDecoration:'none'}} className="mx-4" id={color}>Login</Link>
                    </button>
